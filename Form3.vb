...
Public Class Form3
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Retour_btn.Click
        Me.Hide()
        Form1.Show()
    End Sub
    ...
    Private Sub LBNom_(sender As Object, e As EventArgs) Handles LBNom.SelectedIndexChanged
        ...
        If LBNom.SelectedItem <> Nothing Then
            ComboBox1.Text = LBNom.SelectedItem.ToString
        End If
    End Sub
    ...
    Private Sub Rechercher_btn_Click(sender As Object, e As EventArgs) Handles Rechercher_btn.Click
        For i = 0 To LBNom.Items.Count - 1
            If ComboBox1.Text.Equals(LBNom.Items.Item(i)) Then
